...
abstract class Model {
    ...
    const DATETIME_AUTO_ON_UPDATE = 'DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP';
    ...
    const TIMESTAMP_AUTO_ON_UPDATE = 'TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP';
